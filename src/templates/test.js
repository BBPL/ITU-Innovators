...
export const TestPageTemplate = ({
  ...
  const events = [
    {
      name: "Event with small description",
      description: "lorem ipsum dolor ipsos custodes",
      src:
        "https://spectratherapies.com/wp-content/uploads/2017/06/LSS-Autism-Acceptance.jpg"
    },
    {
      name: "Women in Tech 25/2/19 18:00 - 21:00",
      description:
        "ARYZE proudly hosts Women in Tech which is the sequel to the popular Women in Fintech event.    The event will take place at the IT University of Copenhagen on the 25th of February and is hosted in cooperation with IT-Branchen and ITU Innovators with the goal of addressing the lack of female representation in the sector and asking why it is so.",
      src:
        "https://spectratherapies.com/wp-content/uploads/2017/06/LSS-Autism-Acceptance.jpg"
    },
    {
